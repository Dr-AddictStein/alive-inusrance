          ...
          <div className='max-w-[400px] mx-auto py-20 space-y-5'>
            ...
            <div className="mt-4">
              ...
              <div className='flex justify-end items-center gap-5 py-20'>
                {/* Here all buttons */}
                <button disabled onClick={previousStep} className="bg-[#AEB2B4] border border-gray-400 text-white px-10  py-2 rounded ">Cancel</button>
                {!isLastStep && (
                  <div onClick={handleButtonClick} className='flex cursor-pointer justify-center items-center gap-2 bg-blue-600 px-10'>
          ...
          <div className=' py-20'>
            ...
            <div className='flex justify-between items-center gap-5 py-10'>
              ...
              <div className='flex justify-center items-center gap-5'>
                ...
                {isLastStep && (
                  <button onClick={handleButtonClick} className="bg-[#2baff1] px-10 text-white py-2 rounded ">Active</button>
                )}
              </div>
            </div>
          </div>
